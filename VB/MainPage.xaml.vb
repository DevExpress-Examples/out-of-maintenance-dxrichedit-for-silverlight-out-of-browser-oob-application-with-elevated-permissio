	...
	Partial Public Class MainPage
		...
		Private Sub btnLoadImage_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			If featureComplete Then
				richEditControl1.Document.InsertImage(richEditControl1.Document.Range.End, DocumentImageSource.FromUri("http://www.devexpress.com/Home/i/logos/preview.png", richEditControl1))
			Else
